...
- **阶段战斗**：普通敌机 → 快速敌机 → 射击敌机 → Boss 战，难度递增
- **双渲染后端**：Direct2D（硬件加速）/ GDI+（兼容回退）
- **可变分辨率**：支持 4:3 / 16:9 / 16:10 / 21:9 / 32:9 共 20 种分辨率
- **高 DPI 支持**：任意缩放比例下 UI 一致
- **可变游戏速度**：慢速 45 / 中速 60 / 快速 90 tick/s 可调
- **5 种主题**：Classic / Neon / Lava / Aurora / Mono
- **帧率**：60 / 75 / 120 / 144 / 165 / 240 Hz
- **性能监视器**：实时 FPS + 内存占用显示
